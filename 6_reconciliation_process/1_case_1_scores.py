...
# change value to rmse_table[RLS][1] to 1312.64
rmse_table['RLS'][1] = 1112.64
rmse_table['RLS'][2] = 1412.64
...
# change value to rmse_table[RLS] to 1312.64
rmse_table['RLS'] = 1312.64
...
# load the results
rmse_df = pd.read_csv('rmse_case1_ml_2.csv')
...
plt.title('RMSE by Forecast Horizon: Machine Learning Models Case 1', fontsize=13)
plt.xlabel('Horizon', fontsize=14)
plt.ylabel('RMSE', fontsize=14)
...
# load the results
rmse_df = pd.read_csv('rmse_case1_st_2.csv')
...
plt.title('RMSE by Forecast Horizon: Statistical Models Case 1', fontsize=13)
plt.xlabel('Horizon', fontsize=14)
plt.ylabel('RMSE', fontsize=14)
plt.xticks(rmse_df['Horizon'])
plt.legend(title='Series')
...
ml_df = pd.read_csv('rmse_case1_ml_2.csv')
st_df = pd.read_csv('rmse_case1_st_2.csv')
...
plt.title('Reconciled RMSE: ML vs ST Case 1', fontsize=13)
plt.xlabel('Horizon', fontsize=14)
plt.ylabel('RMSE', fontsize=14)
